...
const updateBackground = (newBackgroundName: string) => {
  if(newBackgroundName !== currentLayerName) {

    const layer = cachedLayers[newBackgroundName]
    ...
    currentLayerName = newBackgroundName
  }
}
